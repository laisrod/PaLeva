            ...
            {establishmentCode && (
              <div className="owner-nav-links">
                <Link
                  ...
                  className={`owner-nav-link ${isActive(`/establishment/${establishmentCode}`) && !isActive('/menus') && !isActive('/dishes') && !isActive('/drinks') && !isActive('/orders') && !isActive('/desserts') && !isActive('/tags') && !isActive('/working-hours') && !isActive('/ratings') && !isActive('/jobs') ? 'active' : ''}`}
                  title="Dashboard"
                >
                ...
                <Link
                  to={`/establishment/${establishmentCode}/ratings`}
                  className={`owner-nav-link ${isActive('/ratings') ? 'active' : ''}`}
                  title="Avaliações"
                >
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="nav-icon">
